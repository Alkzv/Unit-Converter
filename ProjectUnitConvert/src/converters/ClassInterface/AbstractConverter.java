...
public abstract class AbstractConverter {
    ...
    /**
     * Abstract method that will be implemented in the other classes that
     * extends this class
     *
     * @param unit
     * @return Double - unit
    ...
    /**
     * Method that receives a name of a propertie of enum and get this propertie
     * content and save in a list
     *
     * @return list
     */
